...
exports.transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
    // user: 'muritadohsodeeq97@gmail.com',
    // pass: 'sirunique1997',
...
exports.registerVerificationEmail = (to, verify_url, verify_pin, subject) => {
  return {
    from: 'muritadohsodeeq97@gmail.com',
    to: 'muritadohsodeeqtunde@gmail.com',
    subject: subject,
    html: `
                                                ...
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        into your web browser: <a
                                                            ...
                                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3869d4;">${verify_url}</a>
                                                    </p>
                                                </td>
                                            </tr>
                                        </table>
...
exports.passwordResetEmail = (to, verify_url, verify_pin, subject) => {
  return {
    from: 'muritadohsodeeq97@gmail.com',
    to: 'muritadohsodeeqtunde@gmail.com',
    subject: subject,
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell"
                                        ...
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            If you did not initiate this request. please contact us immediately at support@team.com
                                            </p>
                                        <p
                                            style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                            Our warm regards,<br><br>
...
exports.createStoreVerificationEmail = (
  to,
  verify_url,
  verify_pin,
  subject
                              ...
                              <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                  ...
                                  <tr>
                                      <td class="content-cell"
                                          ...
                                          <p
                                              style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                              To comple the verification enter the verification code on your recognized device
                                          </p>
                                          <p
                                              style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                              Verification Code : ${verify_pin}
                                          </p>
                                          <p
                                              style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; font-size: 15px; line-height: 1.5em; margin-top: 0; text-align: left;">
                                              OR
